...
class DealsCard extends StatelessWidget {
  const DealsCard({super.key, required this.mq});
          ...
          Row(
            children: [
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(text: "year", style: AppTextStyles.normalText),
                  ],
                ),
              ),
              Spacer(),
              Container(
                ...
                child: Text(
                  "BEST VALUE",
                  style: AppTextStyles.normalText.copyWith(fontSize: 10,fontWeight: FontWeight.bold),
                ),
              ),
            ],
          ),
